...
public class GestionEmpleado {
    ...
    // constructor
    public GestionEmpleado(String nombre, String apellido, int edad, double salario) {
        this.nombre = nombre;
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            GestionEmpleado empleado1 = new GestionEmpleado(nombre, apellido, edad, salario);
